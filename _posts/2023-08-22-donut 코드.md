...
tag: [code]
toc: true
excerpt: " ![image](http://img.youtube.com/vi/DEqXNfs_HhY/0.jpg) "
---
...
> - R2를 중심으로 반지름이 R1인 원을 생성하고 ![image](https://www.a1k0n.net/img/torusxsec.png)
...
> <pre id="d2" style="background-color:#000; color:#ccc; font-size: 10pt;"></pre>                                
> </body>
> </html>
> 
